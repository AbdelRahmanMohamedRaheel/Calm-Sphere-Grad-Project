...
export default function Card16() {
    return (
        <div className="card16-root">
            <div className="card16-container">
                <div className="card16-content">
                    <div className="card16-header">
                        <p className="card16-category">Theories</p>
                        <h1 className="card16-title">What Is Reaction Formation?</h1>
                    </div>

                    <div className="card16-image-wrapper">
                        <img
                            src="/photo16.webp"
                            alt="Reaction Formation"
                            className="card16-image"
                        />
                    </div>

                    <div className="card16-prose">
                        <p>
                        ...
                        <h2>History of Reaction Formation</h2>
                        <p>
                        ...
                        <h2>How to Recognize Reaction Formation</h2>
                        <p>
                        ...
                        <h2>Examples of Reaction Formation</h2>
                        <p>
                        ...
                        <h2>Evidence for Reaction Formation</h2>
                        <p>
                        ...
                        <h2>How to Address Reaction Formation</h2>
                        <p>
