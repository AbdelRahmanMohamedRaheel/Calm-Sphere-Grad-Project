...
class PreVisitReport(models.Model):
    appointment = models.OneToOneField(Appointment, on_delete=models.CASCADE, related_name="previsit_report")
    conversation = models.JSONField()  # Stores the chat as an array of messages
    submitted_at = models.DateTimeField(auto_now_add=True)

    def __str__(self):
        return f"PreVisit Report for {self.appointment}"