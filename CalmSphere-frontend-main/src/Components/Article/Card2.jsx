            ...
            <div className="card2-container">
                <div className="card2-box">
                    <div className="card2-header">
                        <p className="card2-subtitle">Theories</p>
                    ...
                    <div className="card2-content">
                        ...
                        <h2 className="card2-heading2">Understanding the Fiedler Contingency Model</h2>
                        <p className="card2-paragraph">
                        ...
                        <h2 className="card2-heading2">Situational Favorableness in Fiedler's Theory</h2>
                        <p className="card2-paragraph">
                        ...
                        <ul className="card2-list">
                            <li className="card2-list-item">
                                <strong>Leader-member relations</strong>, which has to do with trust between the team and the leader. The more trust the team places in a leader, the more favorable the situation.
                            </li>
                            <li className="card2-list-item">
                                <strong>Task structure</strong>, which relates to how clearly the tasks required to complete a project have been communicated. The more clear-cut the tasks are, the higher the task structure, and the higher the task structure, the more favorable the situation.
                            </li>
                            <li className="card2-list-item">
                                <strong>Position power</strong>, which refers to the amount of authority the leader has over their team. When the leader’s power position is high, the leader will be best positioned to usher the team through reward or punishment. Higher position power makes for a more favorable situation.
                            </li>
                        </ul>
                        ...
                        <h2 className="card2-heading2">Leadership Styles in Fiedler's Theory</h2>
                        <p className="card2-paragraph">
                        ...
                        <h2 className="card2-heading2">Examples of Fiedler's Contingency Theory</h2>
                        <p className="card2-paragraph">
                        ...
                        <h2 className="card2-heading2">Potential Downsides of Fiedler's Theory</h2>
                        <p className="card2-paragraph">
                        ...
                        <h2 className="card2-heading2">Takeaways</h2>
                        <p className="card2-paragraph">
